...
<#
.SYNOPSIS
    Deploy World War Game to Kubernetes

.DESCRIPTION
    Deploys the World War Game strategic board game to SRT-HQ Kubernetes cluster
...
$APP_NAME = "world-war-game"
$NAMESPACE = "world-war-game"
$IMAGE = "suparious/world-war-game:latest"
$K8S_DIR = "k8s"
...
Write-Host ""
Write-ColorOutput "Access the application at: https://worldwar.lab.hq.solidrust.net" 'Yellow'
Write-Host ""
